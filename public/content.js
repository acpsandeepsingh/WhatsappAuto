...
async function injectMessage(text) {
  ...
  console.log(`[WA Auto] Sending message via Enter`);
...
async function handleAttachment(attachment, caption = "") {
  ...
  console.log(`[WA Auto] Waiting for attachment preview...`);
  ...
  if (!captionBox && !sendBtnPreview) {
    console.warn(`[WA Auto] Paste method failed, trying fallback...`);
